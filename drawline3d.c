...
//	static int cnt = 0;
		...
		if (!(point1.x < 0 - renderer->win_x*0.25 || point1.x > renderer->win_x*1.25
			  || point2.y < 0 - renderer->win_y*0.25 || point2.y > renderer->win_y*1.25
			  || point1.color == 0x4F000000 || point2.color == 0x4F000000/*
			  || point_a.z == -2147483648 || point_b.z == -2147483648*/))
		{
